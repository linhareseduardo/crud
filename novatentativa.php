...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Preparar a instrução SQL para atualizar os dados do produto
        ...
        // Bind dos parâmetros
        $stmt->bindParam(':cnpj', $editCnpj);
        $stmt->bindParam(':razaoSocial', $editRazaoSocial);
        $stmt->bindParam(':nomeFantasia', $editNomeFantasia);
